...
/**
 * VaporizingRow is a transient row. It lives in the specified heap. It is vaporized when the heap is gone. This class
 * is mostly used in updating data in Humpback. It is friendly with EA.
 *  
 * @author wgu0
 */
