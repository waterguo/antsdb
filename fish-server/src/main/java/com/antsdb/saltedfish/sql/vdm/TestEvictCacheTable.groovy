 ...
 * @author *-xguo0<@
 */
class TestEvictCacheTable extends TestHBaseBase {
    Sql db;
    ...
    public void test() {
        ...
        assertTrue(mtable.getPageCount() > 1);
        db.execute(".EVICT CACHE TABLE " + gtable.id);
        assertEquals(0, mtable.getPageCount());
    }
}
