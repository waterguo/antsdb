...
import com.antsdb.saltedfish.lexer.MysqlParser.Drop_view_stmtContext;
 ...
 * @author *-xguo0<@
 */
public class Drop_view_stmtGenerator extends Generator<Drop_view_stmtContext> {

    @Override
    public Instruction gen(GeneratorContext ctx, Drop_view_stmtContext rule) throws OrcaException {
        ...
        DropTable drop = new DropTable(list, ifExist, it -> {
            return it.getType() == OrcaTableType.VIEW;
        });
        return drop;
    }
