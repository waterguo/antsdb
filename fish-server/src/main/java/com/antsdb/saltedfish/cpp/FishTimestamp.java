...
public final class FishTimestamp extends BrutalMemoryObject {
    static final int SIZE = 9;
    
    public FishTimestamp(long addr) {
        super(addr);
    }
    ...
    public int getFormat() {
        return Value.FORMAT_TIMESTAMP;
    }

    public static boolean isAllZero(Timestamp time) {
        return time.getTime() == Long.MIN_VALUE;
    }
